...
## Major Activities
* **Build a vertical prototype.** Using Axure, build a vertical prototype that addresses all of the "must have" task requirements you identified in P1. This prototype should be functional in terms of the interaction flow. The goal, remember, is to allow someone to understand how it would feel to interact with the system. 

Note: This is a little bit tricky. PLEASE ask your TA about how much functionality is appropriate.
...
# Deliverable
* There are two deliverables: an in-tutorial demo to your TA, and a portfolio component on the GitHub site.
...
* On the due date for this project component, you will submit your GitHub site. This portfolio piece should contain the following:
    * A link to the working demo
    * Three "highlight" pieces of functionality (e.g. tasks), accompanied by either images (gifs?) and some text to explain how a user would use the system to accomplish the task.
    ...
    * Include as a set of images the raw notes from your heuristic evaluation -- in particular, the notes from your individual heuristic evaluations.
